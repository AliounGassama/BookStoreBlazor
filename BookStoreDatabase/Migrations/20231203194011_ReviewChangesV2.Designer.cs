...
namespace BookStoreDatabase.Migrations
{
    ...
    [Migration("20231203194011_ReviewChangesV2")]
    partial class ReviewChangesV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Book", b =>
                {
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.CartLineItem", b =>
                {
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Genre", b =>
                {
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Cart", b =>
                {
                    b.HasOne("BookStoreDatabase.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.CartLineItem", b =>
                {
                    b.HasOne("BookStoreDatabase.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStoreDatabase.Entities.Cart", null)
            ...
            modelBuilder.Entity("BookStoreDatabase.Entities.Genre", b =>
                {
                    b.HasOne("BookStoreDatabase.Entities.Book", null)
                        .WithMany("Genres")
                        .HasForeignKey("BookId");
                });
